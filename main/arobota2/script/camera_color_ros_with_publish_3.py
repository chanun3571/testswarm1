...
class color_shape_detection:
    ...
    def __init__(self):
        rospy.init_node('robot3_camera_shape_color_cv',anonymous=True)
        self.pubz = rospy.Publisher('robot3/depth', String, queue_size=10)
        self.pubx = rospy.Publisher('robot3/x', String, queue_size=10)
        rospy.Subscriber("robot3/image/compressed", CompressedImage, self.image_callback)
        self.bridge = CvBridge()
        self.pubimgstatus = rospy.Publisher('robot3/camera_status', String, queue_size=10 )
