...
class OmniTf:
    def __init__(self):
        ...
        self.base_frame_id = rospy.get_param('~base_frame_id', "robot2/base_footprint") # the name of the base frame of the robot
        self.odom_frame_id = rospy.get_param('~odom_frame_id', "robot2/odom") # the name of the odometry reference frame
