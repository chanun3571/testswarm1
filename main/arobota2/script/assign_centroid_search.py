...
class publish_goal_pose_to_robot():
    ...
    def CustomWayPoints(self):
        ...
        # self.locations['6'] = Point(-0.2, 0.0, 0.000)
        ...
        self.locations['7'] = Point(-0.3, -0.4, 0.000)  
        # self.locations['27'] = Point(0.2, -0.5, 0.000)
        self.locations['8'] = Point(0, -0.5, 0.000)
        # self.locations['29'] = Point(0.4, -0.2, 0.000)
        self.locations['9'] = Point(0.4, -0.8, 0.000)
        # self.locations['30'] = Point(0.4, -0.6, 0.000)
        self.locations['10'] = Point(0.6, -0.6, 0.000)
        self.locations['11'] = Point(0.8, -0.8, 0.000)
        self.locations['12'] = Point(1, -0.8, 0.000)
        self.locations['13'] = Point(1.2, -1, 0.000)
        self.locations['14'] = Point(1.2, -1.3, 0.000)
