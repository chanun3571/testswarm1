...
class publish_goal_pose_to_robot():
    def __init__(self):
        ...
        self.pubsend = rospy.Publisher('/swarm1/done', String, queue_size=1)
        self.locations = dict()
        self.totalflag = 0 
        self.flag1 = 0
        self.flag2 = 0
    ...
    def CustomWayPoints(self):
        ...
        self.locations['waypoint2'] = Pose(Point(-1, 0, 0.000),Quaternion(0.000, 0.000, -0.717, 0.697))
        self.locations['waypoint3'] = Pose(Point(-0.8, 0, 0.000), Quaternion(0.000, 0.000, -0.717, 0.697))
